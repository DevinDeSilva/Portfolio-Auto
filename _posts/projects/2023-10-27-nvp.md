		...
		<div class="inner no-padding">
			<div class="tag-container">
                    <ul class="actions">
						...
						<li><a href="#" class="button special small disable"><i class="fab fa-certificate"></i></a><a href="https://drive.google.com/file/d/1_by4Vxbjj341oY0Xyv1FldULncdpaRPX/view?usp=sharing" class="button small">Certificate</a></li>
                    </ul>
            </div>
			<div>
				<h2>Description</h2>
	...
	<section id='third'>
		<div class="inner no-padding">
			<div>
				...
				<iframe src="https://drive.google.com/file/d/1_by4Vxbjj341oY0Xyv1FldULncdpaRPX/preview" width="640" height="480" allow="autoplay"></iframe>
			</div>
			<div>
